        ...
        <div className="flex w-full items-end mt-custom mt-[4vw] md:mt-[6.37vh]">
            <div className="hidden lg:block pt-custom pt-[7.08vh] pb-custom pb-[6.23vh] z-[100]">
                <div className="relative h-mapa-custom h-[80vh] w-mapa-custom w-[43.9vh]">
                    ...
                    <div className="h-[3.68vh] w-[3.68vh] point-map hover:scale-110 transform ease-in-out duration-300 salta top-[4.37vh] right-[25vh] absolute cursor-pointer" onClick={() => handleMapPointClick('salta-section')}>
                        <Image
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute cordoba top-[23vh] right-[23.23vh] cursor-pointer" onClick={() => handleMapPointClick('cordoba-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute santa-fe top-[24vh] right-[18.27vh] cursor-pointer" onClick={() => handleMapPointClick('santafe-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute bsas-norte top-[30vh] right-[13.45vh] cursor-pointer" onClick={() => handleMapPointClick('bsas-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute bsas-sur top-[36.5vh] right-[13.45vh] cursor-pointer" onClick={() => handleMapPointClick('bsas-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute neuquen top-[42vh] right-[35vh] cursor-pointer" onClick={() => handleMapPointClick('neuquen-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute chubut-norte top-[57vh] right-[30vh] cursor-pointer" onClick={() => handleMapPointClick('chubut-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                    ...
                    <div className="point-map h-[3.68vh] w-[3.68vh] hover:scale-110 transform ease-in-out duration-300 absolute chubut-sur top-[68vh] right-[32vh] cursor-pointer" onClick={() => handleMapPointClick('chubut-section')}>
                        <Image
                            src="/bares/point-mapa.png"
                            alt=""
                            fill
                ...
                <div className="lg:h-[65.72vh] lg:w-[454.87vh] pt-[5.94vh] flex flex-row justify-start items-start ">
                    <div className="buenos-aires grid grid-rows-3 grid-flow-col gap-4 gap-x-[1.84vh] text-white relative">
                        {data.bares.buenosAires.map((bar, index) => (
                            <div key={index} className="border-l-2 border-white border-dashed relative w-[84.61vw] h-[24.87vw] md:w-[43.20vh] md:h-[16.57vh]" id="bsas-section">
                                {bar.header && (
                    ...
                    <div className="cordoba hidden lg:grid grid-rows-3 grid-flow-col gap-4 gap-x-[1.84vh] text-white" id="cordoba-section">
                    ...
                    <div className="salta hidden lg:grid grid-rows-3 grid-flow-col gap-4 gap-x-[1.84vh] text-white" id="salta-section">
                    ...
                    <div className="chubut hidden lg:grid grid-rows-3 grid-flow-col gap-4 gap-x-[1.84vh] text-white" id="chubut-section">
