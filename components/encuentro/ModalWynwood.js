  ...
  return (
    <div className="fixed z-[100] inset-0 overflow-y-auto" id="error-modal" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block bg-[#ECEBEB] shadow-xl rounded-t-xl transform transition-all align-middle w-[85.38vw] h-[106.92vw] md:w-[149.43vh] md:h-[85vh]">
                ...
                <div className="content p-[5.89vw] md:p-[3.8vh]">
                  <ScrollHorizontal>
                    <div className="relative w-[472.05vw] h-[84.1vw] md:w-[403.96vh] md:h-[71.81vh] shadow-xl ">
                      <Image src="/encuentros/culture/opening-image.jpg" fill alt="encuentros-flyer" className="block" />
                    </div>
                  </ScrollHorizontal>
                </div>
            </div>
