            ...
            <div className="px-[5.12vw] lg:px-0 space-y-20 relative overflow-hidden">
              <div className="flex flex-col md:flex-row w-full items-end mt-[4vw] md:mt-[6.37vh]">
                <div className="block">
                  <div className="relative w-[80vw] h-[80vw] md:w-[98.86vh] md:h-[93.62vh]">
                    ...
                    <img
                      src="/bares/point-mapa.png"
                      alt="icono punto en el mapa"
                      class="absolute mex top-[40vw] left-[35vw] md:top-[50vh] md:left-[45vh] w-[4vw] h-[4vw] md:w-[5vh] md:h-[5vh] hover:scale-110 transform ease-in-out duration-300 cursor-pointer"
                    />
                    <img
                      src="/bares/point-mapa.png"
                      alt="icono punto en el mapa"
                      class="absolute mex top-[50vw] right-[18vw] md:top-[60vh] md:right-[25vh] w-[4vw] h-[4vw] md:w-[5vh] md:h-[5vh] hover:scale-110 transform ease-in-out duration-300 cursor-pointer"
                    />
                    <img
                      src="/bares/point-mapa.png"
                      alt="icono punto en el mapa"
                      class="absolute mex top-[54vw] right-[12vw] md:top-[66vh] md:right-[23vh] w-[4vw] h-[4vw] md:w-[5vh] md:h-[5vh] hover:scale-110 transform ease-in-out duration-300 cursor-pointer"
                    />
                  </div>
                </div>
                ...
                <div className="lg:h-[65.72vh] lg:w-[454.87vh] pt-[5.94vh] flex flex-col justify-start items-start ">
                  ...
                  <div className="buenos-aires grid grid-cols-1 gap-20 md:grid-cols-3 md:grid-flow-col md:gap-4 gap-x-[1.84vh] text-white relative">
                    {zonas.data.map((bar, index) => (
                      <div
                        key={index}
                        className="border-l-2 border-white border-dashed relative w-[84.61vw] h-[24.87vw] md:w-[43.20vh] md:h-[16.57vh] "
                      >
                        ...
                        <div className="flex flex-col gap-y-[1.79vw] md:gap-y-[0.99vh] pl-[3.58vw] md:pl-[2.40vh] pt-[1.79vw] md:pt-[4.95vh] mx-auto">
                          ...
                          <span
                            className="text-[3vw] md:text-[1.41vh]"
