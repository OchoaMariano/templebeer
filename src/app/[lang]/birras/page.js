...
export default async function Page({ params }) {
  ...
  birras.forEach((birra) => {
    const categoriaSlug =
      birra.attributes.categorias_birra.data.attributes.slug;
        ...
        <div className="grid content-center lg:content-end h-full pb-[7.08vh] pt-[16.15vw] lg:pt-[0] gap-y-[7.69vw] lg:gap-y-[0]">
          ...
          {lang === "es" && (
            <Suspense fallback={<p>Cargando cervezas...</p>}>
              <ScrollHorizontal>
                <div
                  className={`carousel__wrapper  h-[122.82vw] w-[100%] lg:h-[51.98vh] flex flex-row justify-start items-end pl-[10.76vw] lg:pl-[0px] mt-[4.29vw] lg:mt-[0]`}
                >
