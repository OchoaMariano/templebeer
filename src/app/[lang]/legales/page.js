                    ...
                    <ScrollHorizontal>
                        <div className="flex content__wrapper text-white flex-row gap-x-[10vh] items-start w-[400vh] px-[3vh] h-full relative">
                            <div class="w-[70vh] flex flex-col gap-y-[4vh]">
                                ...
                                <div className="flex flex-col gap-y-[2vh]">
                                    <h1 className="text-[3vh] leading-none">INFORMACIÓN DEL USUARIO</h1>
                                    <p className="text-[1.51vh]">
                                ...
                                <div className="flex flex-col gap-y-[2vh]">
                                    <h1 className="text-[3vh] leading-none">USO DE LA INFORMACIÓN DEL USUARIO</h1>
                                    <p className="text-[1.51vh]">
                            ...
                            <div class="w-[70vh] flex flex-col gap-y-[4vh] ">
                                <div class="flex flex-col gap-y-[2vh] ">
                                    <h1 className="text-[3vh] leading-none">COOKIES</h1>
                                    <p className="text-[1.51vh]">
                                ...
                                <div class="flex flex-col gap-y-[2vh] ">
                                    <h1 className="text-[3vh] leading-none">ENLACES A TERCEROS</h1>
                                    <p className="text-[1.51vh]">
                            ...
                            <div class="w-[70vh] flex flex-col gap-y-[4vh] ">
                                <div class="flex flex-col gap-y-[2vh] ">
                                    <h1 className="text-[3vh] leading-none">CONTROL DE SU INFORMACIÓN PERSONAL</h1>
                                    <p className="text-[1.51vh]">
                            ...
                            <div class="w-[70vh] flex flex-col gap-y-[2vh] ">
                                <h1 className="text-[3vh] leading-none">USO QUE HACEMOS DE LA INFORMACIÓN</h1>
                                <p className="text-[1.51vh]">
                            ...
                            <div class="w-[70vh] flex flex-col gap-y-[2vh] ">
                                <h1 className="text-[3vh] leading-none">CESIÓN Y TRANSFERENCIA DE DATOS PERSONALES A TERCEROS</h1>
                                <p className="text-[1.51vh]">
