                ...
                <div className="hidden md:flex flex-col md:flex-row justify-between items-start gap-x-[2.83vh] gap-y-[5.12vw] w-[194.19vh] relative">
                  <div className="bg-[#0e359b] p-[2.83vh] flex flex-col justify-between gap-y-[2.97vh] w-[36.54vh] h-[67.13vh]">
                    ...
                    <div className="text-white h-full flex flex-col justify-center gap-y-[1.41vh]">
                      ...
                      <p className={`text-[1.4vh] font-normal`}>
                        ...
                        potenciador de la cultura urbana de TEMPLE. Un festival
                        en el que músicxs, graffiterxs, bailarines, poetas,
                        intervenciones artísticas y expositores de distintas
                        áreas se encuentran para crear algo único e irrepetible,
                  ...
                  <div className="bg-[#d41768] p-[2.83vh] flex flex-col justify-center gap-y-[2.97vh] w-[36.54vh] h-[67.13vh]">
                    ...
                    <div className="text-white h-full flex flex-col justify-center gap-y-[1.41vh]">
                      ...
                      <p className={`text-[1.4vh] font-normal`}>
                        ...
                        cuatro #ArtistasTEMPLE que nos inspiran por sus ritmos,
                        su vibra y su talento siempre en movimiento.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#1f9996] p-[2.83vh] flex flex-col justify-between gap-y-[2.97vh] w-[36.54vh] h-[67.13vh]">
                    ...
                    <div className="text-white h-full flex flex-col justify-center gap-y-[1.41vh]">
                      ...
                      <p className={`text-[1.4vh] font-normal`}>
                        ...
                        expresión se encuentran, siempre con una birrita en mano
                        y entre amigxs. En vivo desde el Polo Cultural Saldías
                        en la Ciudad de Buenos Aires y en directo para todos los
                        TEMPLE de Argentina.
                      </p>
                    </div>
                  </div>
                  <div className="bg-[#d41768] p-[2.83vh] flex flex-col justify-between gap-y-[2.97vh] w-[36.54vh] h-[67.13vh]">
                    ...
                    <div className="text-white h-full flex flex-col justify-center gap-y-[1.41vh]">
                      ...
                      <p className={`text-[1.4vh] font-normal`}>
                        Un espacio improvisado. Un plano continuo con el
                        ambiente vibrando. Un TEMPLE en cada canción de artistas
                        emergentes que están sonando.
                      </p>
                    </div>
                  </div>
