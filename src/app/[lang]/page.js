...
export default async function Home({ params }) {
  ...
  return (
    <>
          ...
          >
              ...
              <div className="main-box-1-wrapper">
                ...
                <div className="row">
                  <div className="box-1 relative">
                    <h1
                      className={`text-white pl-[2vh] text-[7.08vh] Knockout54UltraBold elementoEfectoVelocidad ${Knockout54UltraBold.className}`}
                    >
                      <Link
                        href={`${lang}/encuentro`}
                        className="text-white hover:text-[#FCDB00] transition duration-300 ease-in-out uppercase"
                      >
                        {dict.home.mainTitle.encuentro}
                      </Link>
                      ,
                      <Link
                        href={`${lang}/birras`}
                        className="text-white hover:text-[#D51668] transition duration-300 ease-in-out uppercase"
                      >
                        {" "}
                        {dict.home.mainTitle.birra}{" "}
                      </Link>
                      {dict.home.mainTitle.y}
                      <Link
                        href={`${lang}/musica`}
                        className="text-white hover:text-[#1F9996] transition duration-300 ease-in-out uppercase"
                      >
                        {" "}
                        {dict.home.mainTitle.musica}{" "}
                      </Link>
                    </h1>
            ...
            <div className="column">
              <div className="row-alt">
                <div className="box-5">
                  {lang == "en" && (
                    <a
                      ...
                      className="w-inline-block group pt-[3.96vh]"
                      target="_blank"
                    >
                      <div className="relative w-[8.07vh] h-[8.21vh]">
                        <Image src="/qrcode.png" alt="icon qr code" fill />
                      </div>
                ...
                <div className="box-6">
                  <Image src="/box-6.png" alt="Temple Beer box" fill />
                </div>
                <div className="box-7">
                  <Image src="/box-7.png" alt="Temple Beer box" fill />
                </div>
                <div className="box-8">
              ...
              <div className="row">
                <div className="box-10 relative z-20">
                  <Link
                    href={`${lang}/encuentro`}
                    className="encuentros w-[44.61vh] h-[61.89vh] -top-[34.5vh] absolute"
                  >
                    <Image
                  ...
                  <Link href={`${lang}/encuentro`}>
                    ...
                    {lang == "en" && (
                      <h3
                        className={`absolute text-[#192F5D] text-[3.82vh] uppercase top-[14vh] left-[15.5vh] -tracking-[.4vh] -rotate-[4.41deg] z-[100] ${Marker.className} cursor-pointer`}
                      >
                        {dict.home.encuentros.link}
                      </h3>
                    )}
      ...
      <div
        className="mobile bg-cover bg-center block md:hidden overflow-hidden"
        style={{ backgroundImage: "url(/background-home.jpeg)" }}
      >
        <div className="mobile-box-1">
          <div className="beer-wrapper-mobile">
            <div className="flex justify-center relative w-[90.51vw] h-[55.89vw]">
              ...
              <Image src="/back-main-image.png" alt="Temple Beer Image" fill />
            </div>
          </div>
          <div className="nav-title-mobile">
            <div className="title-wrapper flex relative">
              <h1
                className={`text-white text-[10.25vw] Knockout54UltraBold elementoEfectoVelocidad ${Knockout54UltraBold.className}`}
              >
                <Link
                  href={`${lang}/encuentro`}
                  className="text-white hover:text-[#FCDB00] transition duration-300 ease-in-out uppercase"
                ...
                <div className="birras-nav w-[55.64vw] h-[64.25vw]">
                  ...
                  <nav className="flex flex-wrap self-stretch">
                    {allBirras.data.map((birraObj, index) => (
                      <span
                        key={index}
                        className={`text-[2.30vw] py-[0.51vw] px-[1.28vw] text-white border-r-[1px] border-dotted border-white ${Knockout34.className}`}
                      >
                        <Link
                          className="text-white hover:text-[#FCDB00] transition duration-300 ease-in-out uppercase"
                          href={`${lang}/birras/${birraObj.attributes.slug}`}
        ...
        <div className="mobile-box-5 flex flex-col mt-[5.12vw] mb-[5.12vw] relative">
          <div className="row-1 flex flex-row items-end">
            <Link
              href={`${lang}/encuentro`}
              className="w-[39.74vw] h-[53.07vw] relative"
            >
              <Image
                src="/encuentros-back.png"
                alt="Encuentro"
              ...
              />
              <h3
                className={`absolute text-[#192F5D] text-[3vw] uppercase top-[42vw] left-[11.8vw] -tracking-[.2vw] -rotate-[4.41deg] ${Marker.className}`}
              >
                {dict.home.encuentros.link}
              </h3>
            </Link>
            <div className="w-[39.74vw] h-[26.07vw] relative flex items-end mb-[7vw]">
              <h3
                className={` text-[#D41768] text-[6.92vw] uppercase -tracking-[.42vw] -rotate-[4.41deg] ${Marker.className} leading-[6vw]`}
              >
                {dict.home.encuentros.frase}
              </h3>
